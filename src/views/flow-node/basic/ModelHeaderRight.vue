...
import TestRunIcon from "../flowIcons/TestRunIcon.vue";
import OmitIcon from "../flowIcons/OmitIcon.vue";

const emit = defineEmits(["testRun", "reName", "deleteNode"]);
...
<template>
  <div class="basic-n-t-right">
    <el-button class="basic-n-t-r-icon" @click="testRun"
      ><IconTestRun
    /></el-button>
