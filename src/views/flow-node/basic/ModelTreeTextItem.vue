...
// import ModelTreeTextItem from './ModelTreeTextItem.vue';

import IconRightArrow from "@iconify-icons/ep/arrow-right";
import { ref } from "vue";
...
<template>
  <div v-if="root" class="model-tree-text-wrapper">
      ...
      >
        <div class="m-t-t-line">
          <div class="m-t-t-line-full-child">
            <div class="m-t-t-line-full-child-line" />
            <div
              class="m-t-t-line-full-child-bottom-line"
