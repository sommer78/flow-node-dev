...
const addItem = () => {
  ...
  const id =
    endNode.value.outputParams.length === 0
      ? 1
      : (
          endNode.value.outputParams[
            endNode.value.outputParams.length - 1
          ] as any
        )?.id + 1;
...
<template>
  <div ref="modeRef" class="end-node-wrapper">
    <div :class="[openCard ? 'end-node-header' : '']">
      <div class="end-node-title">
        ...
        <img
          ...
          alt="e-n-t-start-icon"
          class="e-n-t-start-icon"
        />
    ...
    <div class="end-node-answer" v-if="openCard">
      ...
      <div class="e-n-a-select">
        <el-select
          v-model="endNode.answer.value"
          :placeholder="endNode.answer.placeholder"
          :disabled="endNode.answer.disabled"
          ...
          <el-collapse-item name="result" :disabled="true">
            <template #title>
              ...
              <div class="e-n-c-header-right">
                ...
                <el-switch
                  v-model="endNode.result.streamOutputValue"
            ...
            <div class="e-n-c-result-content">
              <el-input
                type="textarea"
                v-model="endNode.result.value"
                :placeholder="endNode.result.placeholder"
                :disabled="endNode.result.disabled"
