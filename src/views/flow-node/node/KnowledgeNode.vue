...
<template>
  <div ref="modeRef" class="know-model-node-wrapper">
    <div :class="[openCard ? 'know-model-node-header' : '']">
      <div class="know-model-node-title">
        ...
        <img
          ...
          alt="km-n-t-start-icon"
          class="km-n-t-start-icon"
        />
        <div class="km-n-t-text">
          <el-input
            ref="titleRef"
            v-model="knowledgeNode.title.value"
            :placeholder="knowledgeNode.title.placeholder"
            :disabled="knowledgeNode.title.disabled"
      ...
      <div class="know-model-node-subtitle" v-if="openCard">
        <span
          >在选定的知识中,根据输入变量召回最匹配的信息,并以列表形式返回</span
        >
      </div>
    </div>
      ...
      <el-collapse @change="collapseChange" v-model="openCollapseArr">
        <div class="know-model-node-content-item">
          <el-collapse-item name="input" :disabled="true">
            ...
            <div>
              <ParamsItem
                :data="knowledgeNode.input.inputParams"
                key="bmInput"
                :titles="inputTitles"
                :showAddIcon="false"
        ...
        <div class="know-model-node-content-item">
          <el-collapse-item name="output" :disabled="true">
            ...
            <div class="km-n-c-chat-outputlist">
              <ModelTreeText
                :data="knowledgeNode.output.treeData"
                :openAll="true"
